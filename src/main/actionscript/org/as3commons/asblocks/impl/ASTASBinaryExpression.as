...
public class ASTASBinaryExpression extends ASTExpression implements IASBinaryExpression
{
	public function ASTASBinaryExpression(ast:LinkedListTree)
	{
		super(ast);
	}
	...
	{
		return BinaryOperator.opFromType(ast.type);
	}
	
	public function setOperator(value:BinaryOperator):void
	{
		BinaryOperator.initializeFromOp(value, ast.getToken());
	}
